# localmt API & Internals

This document covers the internal architecture, crate boundaries, FFI contract,
and model-pack format in detail. For the quick-start guide, see the project
[`README.md`](../README.md).
...
after any model-pack update or when `localmt_ffi_model_pack_trust_schema_version()`
changes.
